...
public CreateGameMessage createGameMessageDecode(String mess) throws JSONException {
...
public LobbyServerMessage lobbyServerMessageDecode(String mess) throws JSONException {
	JSONObject obj = new JSONObject(mess);
...
public StartableMessage startebleMessageDecode(String mess) throws JSONException {
	JSONObject obj = new JSONObject(mess);
...
public String encode (StartedMessage mess) throws JSONException {
	...
	public StartedMessage startedMessageDecode(String mess) throws JSONException {
		JSONObject obj = new JSONObject(mess);
	...
	public TiarStartMessage tiarStartMessageDecode(String mess) throws JSONException {
		JSONObject obj = new JSONObject(mess);
	...
	public TiarUserMessage tiarUserMessageDecode(String enc) throws JSONException {
	...
	public SnakeServerMessage snakeServerMessageDecode(String mess) throws JSONException{
		JSONObject obj = new JSONObject(mess);
